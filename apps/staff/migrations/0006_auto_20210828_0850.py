    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scientific_works', to='staff.staff')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ru', to='staff.staffscientificworks')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=512)),
                ('magazin_name', models.CharField(max_length=512)),
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='kg', to='staff.staffscientificworks')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=512)),
                ('magazin_name', models.CharField(max_length=512)),
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='en', to='staff.staffscientificworks')),
            ],
            options={
                'abstract': False,
            },
